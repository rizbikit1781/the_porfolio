  ...
  return (
    <div className="py-20" id="projects">
        <h1 className="heading">
            ...
            <span className='text-purple'>projects showcase</span>
        </h1>
        <div className='flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10'>
            {projects.map(({ id, title, des, img, iconLists, link }) => (
                <div key={id} className='sm:h-[32rem] h-[32rem] flex items-center justify-center sm:w-[570px] w-[80vw]'>
                        ...
                        <div className='flex items-center justify-between mt-7 mb-3'>
                            ...
                            <div>
                                <a href={link} target='_blank' className='flex justify-center items-center'>
                                    <p className='flex lg:text-lg md:text-md text-sm text-purple'>
                                        Visit Site
                                    </p>
